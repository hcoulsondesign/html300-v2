    ...
    <section class="container mt-4">
      ...
      <div class="row mx-auto my-3 ">
        ...
        <div class="col-sm-12 col-md-10 col-xl-8 mx-auto text-start my-3 border border-black">
          ...
          <p>Below are brief descriptions with examples of how each sense is used to evaluate a wine. Click the <span class="text-info font-italic">teal</span> words for a full definition or key wine terms.</p>
        ...
        <!-- SIDEBAR INFO -->
        <aside class="col-sm-12 col-md-8 col-xl-3 mx-auto my-3 bg-info text-white font-weight-light">
          <div class="p-3">
            <h3 class="my-4 text-center font-italic">For interest's sake...</h3>
