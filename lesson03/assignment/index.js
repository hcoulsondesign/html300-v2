...
cards.forEach(function(el){
  //create variable for string of code languages
  let languages = el.codeLanguages.join(', ')
  //create an element inside which card html will go
  ...
  <div class="info">
    ...
    <p><span class="spanstyle">Code Languages:</span> ${languages}</p>
  ...
  `
  dir.append(entry) //add new html element to the page
 })
